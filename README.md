...
![Version: 2.5.2-bb.0](https://img.shields.io/badge/Version-2.5.2--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.7.2](https://img.shields.io/badge/AppVersion-v1.7.2-informational?style=flat-square)
...
| replicaCount | int | `1` | (int) Desired number of pods |
...
| webhooksCleanup.image | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.22.2"` | `kubectl` image to run commands for deleting webhooks. |
